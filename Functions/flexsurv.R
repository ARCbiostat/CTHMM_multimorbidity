...
# apply_flexsurv <- function(pop_ms,scenario_obj,result_folder,nsim){
#   
...
apply_flexsurv_base <- function(pop_ms, scenario_obj, result_folder,nsim){
  ...
  save(models_object, file = paste0(result_folder,"/benchmark_model_", nsim,"_", 
                                    unique(pop_ms$dataset_id),".RData"))
  print("flexsurv executed")
}
