...
 
**Manzoni V., Ieva F., Calderón-Larrañaga A., Vetrano D.L., Gregorio C.** *Hidden multistate models to study multimorbidity trajectories*.  Scientific Reports, 16, Article 23711 (2026).
 https://doi.org/10.1038/s41598-026-62471-w
## Overview

Understanding how multimorbidity evolves over time is essential for improving clinical decision-making and public health planning. Traditional approaches often focus on disease counts or predefined disease combinations, which may fail to capture the complexity and dynamic nature of multimorbidity progression.
