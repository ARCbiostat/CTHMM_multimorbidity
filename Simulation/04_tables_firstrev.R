...
lab <- c("Model","Estimate","S.E. Estimate","Mean S.E","Bias","Coverage")

####################################################################
#################### pop-based study 3/6 years ##################### 
####################################################################
load("~/Documents/CTHMM_multimorbidity/results/results_estimates_first_revision/pm_df_est_xb_3000.RData")
load("~/Documents/CTHMM_multimorbidity/results/results_estimates_first_revision/pm_df_est_xb_10000.RData")

table_xb_3000 <-fix_table_rev(pm_df_est_xb_3000)
table_xb_10000 <- fix_table_rev(pm_df_est_xb_10000)
...
load("~/Documents/CTHMM_multimorbidity/results/results_estimates_first_revision/pm_df_est_xc_3000.RData")
load("~/Documents/CTHMM_multimorbidity/results/results_estimates_first_revision/pm_df_est_xc_10000.RData")

table_xc_3000 <- fix_table_rev(pm_df_est_xc_3000)
table_xc_10000 <- fix_table_rev(pm_df_est_xc_10000)
...
save(table_t1,table_t2,table_t3,file = c("Tables/Simulation_result_tables_rev.RData"))
