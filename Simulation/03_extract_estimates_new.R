...
####################################################################
#3000
model_est_bench_3000 <-load_and_extract_est(results_path =paste0("results/results_20250522_101420_benchmark_3000","/"), nsim=3000,
                                            N=100, st="benchmark",models="benchmark_model")

model_est_bench_10000 <-load_and_extract_est(results_path =paste0("results/results_20250522_101850_benchmark_10000","/"), nsim=10000,
                                            N=100, st="benchmark",models="benchmark_model")
...
### 3000
model_est_xc_3000 <- load_and_extract_est(results_path =paste0("Simulation/results/results_20250517_141958_xc_3000","/"), nsim=3000,
...
pm_df_est_xb_3000 <-  pm_df_est_xb_3000 %>% filter(model!="benchmark model")
pm_df_est_xb_3000 <- rbind(pm_df_est_xb_3000, pm_df_est_bench_3000)
save(pm_df_est_xb_3000, file =paste0(result_folder,"/pm_df_est_xb_3000.RData"))

## 10000
pm_df_est_xb_10000 <- compute_pm(model_est_xb_10000$param_df,true_param) 
pm_df_est_xb_10000 <-  pm_df_est_xb_10000 %>% filter(model!="benchmark model")
pm_df_est_xb_10000 <- rbind(pm_df_est_xb_10000, pm_df_est_bench_10000)
save(pm_df_est_xb_10000, file =paste0(result_folder,"/pm_df_est_xb_10000.RData"))
####################################################################
#################### irregular observations ######################## 
####################################################################
...
pm_df_est_xc_3000 <-  pm_df_est_xc_3000 %>% filter(model!="benchmark model")
pm_df_est_xc_3000 <- rbind(pm_df_est_xc_3000, pm_df_est_bench_3000)
save(pm_df_est_xc_3000, file =paste0(result_folder,"/pm_df_est_xc_3000.RData"))

## 10000
pm_df_est_xc_10000 <- compute_pm(model_est_xc_10000$param_df,true_param) 
pm_df_est_xc_10000 <-  pm_df_est_xc_10000 %>% filter(model!="benchmark model")
pm_df_est_xc_10000 <- rbind(pm_df_est_xc_10000, pm_df_est_bench_10000)
save(pm_df_est_xc_10000, file =paste0(result_folder,"/pm_df_est_xc_10000.RData"))